  ...
  <body class="container">
          ...
          try
            {
              ...
              $query="select id,item,class,image,containment,description,reference,additional from scp where id=:id";
           ...
           $additional =$row['additional'];
            ...
            if($_POST)
            {
             ...
             {
              //update sql query
              $query="update scp set id=id,item=:item,class=:class,image=:image,containment=:containment,description=:description,reference=:reference,additional=:additional where id=:id";
              ...
              //save post values from the form
                 $id=htmlspecialchars(strip_tags($_POST['id']));
                  ...
                  $update->bindParam(':description',$description);
                    $update->bindParam(':reference',$referenceadditional);
   ...
   <h2>Enter a new scp Record. </h2>
    ...
    <br>
       <p>additional</p>
    <br>
    <input type="text" class="form-control" name="additional"  value="<?php echo htmlspecialchars($additional, ENT_QUOTES); ?>">
